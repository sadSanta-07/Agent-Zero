...
export function TelemetryPanel({
  ...
  return (
    <aside className="w-full lg:w-85 border-t lg:border-t-0 lg:border-l border-brand-border bg-brand-surface p-4 sm:p-5 lg:p-6 flex flex-col justify-between shrink-0 h-[360px] sm:h-[420px] lg:h-full overflow-hidden">
      <div className="flex flex-col h-full min-h-0 gap-4">
        
        {/* Header Section */}
        <div className="flex flex-wrap justify-between items-center gap-2 border-b border-brand-border pb-3 shrink-0">
          <h3 className="text-[11px] uppercase tracking-widest font-space-mono font-bold text-brand-text-secondary flex items-center gap-2 m-0">
        ...
        <p className="hidden sm:block text-[14px] font-public-sans text-brand-text-secondary leading-relaxed shrink-0 m-0">
        ...
        <div className="border-t border-brand-border pt-4 grid grid-cols-3 gap-2 sm:gap-3 shrink-0 text-center text-[10px] font-space-mono font-bold text-brand-text-secondary">
